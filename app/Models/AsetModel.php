...
class AsetModel extends Model
{
    ...
    protected $allowedFields = ['nomor', 'sub_nomor', 'satuan', 'kode_barang', 'no_aset', 'tercatat', 'kode_lokasi', 'kode_perkap', 'kondisi_aset', 'uraian_aset', 'uraian_perkap', 'kode_ruang', 'uraian_ruang', 'kode_gedung', 'catatan', 'kondisi', 'nominal_aset', 'foto', 'tanggal_pengadaan', 'sumber_pengadaan', 'qr_code', 'user_penginput', 'created_at', 'deleted_at'];
